Linked list is a type of dynamic data structure in which each element contains a [[Pointer]] to another element in the list. The elements here are called **nodes**.
